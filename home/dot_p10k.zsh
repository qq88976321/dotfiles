# Generated by Powerlevel10k configuration wizard on 2021-09-29 at 20:24 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    mise                    # mise development environment setup tool (https://github.com/jdx/mise)
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_BACKGROUND=dodgerblue1
